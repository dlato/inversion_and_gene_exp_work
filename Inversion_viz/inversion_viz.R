...
levels(ps_dat$x) <- list("K-12 MG1655"="U00096000", "K-12 DH10B"="NC_010473", "BW25113"="NZ_CP009273", "ATCC 25922"="CP009072")
ps_dat$x <- factor(ps_dat$x, rev(c("K-12 MG1655", "K-12 DH10B", "BW25113", "ATCC 25922")))
head(ps_dat)
summary(ps_dat)
