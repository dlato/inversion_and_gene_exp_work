...
all_inver <- rev_comp_inf %>% filter(ATCC_GSE94978_1 == 1)
head(all_inver)
print("############    ")
print("# Total number of inversions identified")
print("############    ")
length(all_inver$ATCC_GSE94978_1)
ATCC_inver <- rev_comp_inf %>% filter(ATCC_GSE94978_1 == 1 & K12DH_GSE98890_2 == 0)
head(ATCC_inver)
print("############    ")
print("# Total number of inversions identified in ATCC")
print("############    ")
length(ATCC_inver$ATCC_GSE94978_1)
DH_inver <- rev_comp_inf %>% filter(K12DH_GSE98890_2 == 1)
head(DH_inver)
print("############    ")
print("# Total number of inversions identified in DH and ATCC (DH does not have any inversions by itself)")
print("############    ")
length(DH_inver$ATCC_GSE94978_1)
